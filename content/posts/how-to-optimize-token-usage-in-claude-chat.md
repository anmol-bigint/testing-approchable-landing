---
title: How to Optimize Token Usage in Claude Chat
date: 2026-09-01
excerpt: Hitting your Claude limit earlier than expected usually isn't bad luck — it's a handful of habits quietly burning tokens. Seven changes that stretch your usage further, starting with your next chat.
coverImage: /images/posts/how-to-optimize-token-usage-in-claude-chat.webp
...
![The Claude model picker showing Haiku, Sonnet, and Opus options for matching model size to task complexity](/images/posts/how-to-optimize-token-usage-in-claude-chat-model-picker.webp)
